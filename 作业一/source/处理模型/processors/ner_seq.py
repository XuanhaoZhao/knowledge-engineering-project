...
def convert_examples_to_features(examples,label_list,max_seq_length,tokenizer,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # embedding vector (and location vector). This is not *strictly* necessary
...
class CnerProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["X",'B-LOC','B-PER','B-ORG',
                'I-LOC','I-PER','I-ORG',
                'O','S-PER','S-ORG',"[START]", "[END]"]
...
class CluenerProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["X", "B-address", "B-book", "B-company", 'B-game', 'B-government', 'B-movie', 'B-per',
                'B-organization', 'B-location','B-scene',"I-address",
                "I-book", "I-company", 'I-game', 'I-government', 'I-movie', 'I-per',
                'I-organization', 'I-location','I-scene',
                "S-address", "S-book", "S-company", 'S-game', 'S-government', 'S-movie',
                'S-name', 'S-organization', 'S-location',
                'S-scene','O',"[START]", "[END]"]
